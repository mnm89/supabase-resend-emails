...
export type Config<T> = T extends z.ZodEffects<infer Inner> ? Config<Inner>
  : T extends z.ZodObject<infer Shape> ? {
      [K in keyof Shape]?: Config<Shape[K]> | FieldConfig;
    }
  : T extends z.ZodArray<infer Element> ? Config<Element> | FieldConfig
  : FieldConfig;

export interface ZFormProps<TSchema extends ZodObjectOrWrapped>
  extends ZFormBaseProps<TSchema>, ZFormComponentsProps {
